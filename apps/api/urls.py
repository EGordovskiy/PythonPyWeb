...
urlpatterns = [
    ...
    path('author_generic/', AuthorGenericAPIView.as_view(), name='author-generic-list'),
    path('author_generic/<int:pk>/', AuthorGenericAPIView.as_view(), name='author-generic-detail'),
