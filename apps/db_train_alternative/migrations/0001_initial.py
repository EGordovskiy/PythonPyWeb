# Generated by Django 4.2.5 on 2024-10-16 15:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug_name",
                    models.SlugField(unique=True, verbose_name="Slug название"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="db_train_alternative.author",
                    ),
                ),
                (
                    "blog",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="entries",
                        to="db_train_alternative.blog",
                    ),
                ),
                (
                    "tags",
                    models.ManyToManyField(
                        related_name="entries", to="db_train_alternative.tag"
                    ),
                ),
            ],
        ),
